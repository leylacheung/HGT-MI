...
![Figure 1|300](https://github.com/user-attachments/assets/5793ad7a-70bb-4579-9358-983ffe19c2ee)

## Overall Framework
![Figure 2](https://github.com/user-attachments/assets/45c24261-876e-49db-beac-4f78497f0c83)
Figure. RingFormer overview. (a) Atom-, inter-, and ring-level graphs derived from the molecule. (b) Stacked RingFormer layers combining an atom-level GNN, an inter-level GNN, and a ring-level cross-attention. (c) Ring-level attention mechanism with a virtual node.![image](https://github.com/user-attachments/assets/dcac4029-783b-485c-9b3e-5d8711f544a5)

![Figure 3](https://github.com/user-attachments/assets/13c08bc3-8dcc-4cae-8bd7-221eb4c84cbc)
Figure: Overview of MotiFormer's architecture, demonstrating donor-acceptor interactions through motif-level, inter-level, and atom-level graph processing, with cross-attention and message-passing employed to predict OSC properties.![image](https://github.com/user-attachments/assets/ccbed561-015a-4d76-b39a-3ab14b3f2df1)
